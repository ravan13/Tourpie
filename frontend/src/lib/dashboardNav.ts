...
export function userNav(t: (key: string, vars?: Record<string, string | number>) => string): DashboardNavItem[] {
  return [
    ...
    { href: "/dashboard/requests", label: t("dash_requests"), icon: "📝" },
    { href: "/dashboard/offers", label: t("dash_offers"), icon: "🎁" },
...
export function agencyNav(t: (key: string, vars?: Record<string, string | number>) => string): DashboardNavItem[] {
  return [
    ...
    { href: "/agency/incoming-requests", label: t("agency_nav_incoming_requests"), icon: "📨" },
...
export function adminNav(t: (key: string, vars?: Record<string, string | number>) => string): DashboardNavItem[] {
  return [
    ...
    { href: "/admin/trip-requests", label: t("admin_nav_trip_requests"), icon: "📝" },
    { href: "/admin/trip-offers", label: t("admin_nav_trip_offers"), icon: "🎁" },
    { href: "/admin/trip-messages", label: t("admin_nav_trip_messages"), icon: "💬" },
    { href: "/admin/trip-analytics", label: t("admin_nav_trip_analytics"), icon: "📈" },
