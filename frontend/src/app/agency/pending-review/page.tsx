...
export default function AgencyPendingReviewPage() {
  const { t } = useLanguage();
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm p-8">
          <h1 className="text-3xl font-black text-gray-900 mb-2">{t("agency_pending_title")}</h1>
          <p className="text-gray-500 font-medium mb-6">{t("agency_pending_subtitle")}</p>
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-6 text-gray-700 font-medium">
            {t("agency_pending_note")}
          </div>
